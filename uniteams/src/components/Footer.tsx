      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-neutral-300 mb-4 max-w-md">
              La plataforma definitiva para construir equipos increíbles, colaborar sin límites 
              y alcanzar tus metas juntos.
            </p>
        ...
        <div className="border-t border-red-600/30 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">
            © 2024 Uniteams. Todos los derechos reservados.
          </p>
