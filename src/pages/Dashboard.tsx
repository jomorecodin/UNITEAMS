            ...
            return (
              ...
              >
                ...
                <div className="mt-3 space-y-1.5">
                  ...
                  <div 
                    className="flex items-center gap-2 bg-black/30 border border-white/10 rounded px-2 py-1 cursor-pointer hover:bg-black/50 transition-colors"
                    onClick={(e) => {
                      e.preventDefault();
                  ...
                  >
                    <span className="text-[10px] text-neutral-500 uppercase tracking-wider">CÓDIGO:</span>
                    <span className="text-xs font-mono font-bold text-orange-400 tracking-widest">{s.code || '????'}</span>
                    <svg className="w-3 h-3 text-neutral-600 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
